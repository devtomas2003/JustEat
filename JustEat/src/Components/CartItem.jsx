...
export default function CartItem(props){
    return (
        <div className="flex flex-col shadow border rounded relative">
            <div className="bg-red-500 hover:bg-red-600 hover:cursor-pointer p-2 text-white rounded-full items-center justify-center absolute -right-4 -top-5" onClick={() => { props.handleRemoveItem(props.renderId); }}>
